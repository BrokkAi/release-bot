...
Brokk Release Bot uses [Apache-2.0](../LICENSE); [NOTICE](../NOTICE) identifies the
...
Python wheels and source distributions also carry the same legal files.
Wheel license files are installed under the package's `.dist-info/licenses/`
directory.
